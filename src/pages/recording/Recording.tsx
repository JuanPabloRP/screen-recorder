...
import useScreenAndAudio from '../../core/hooks/useScreenAndAudio';

import { RECORDING_STATE } from '../../shared';
			...
			recordingState === RECORDING_STATE.PAUSED ? (
				<section className=" ">
					...
					<section className="flex gap-5  ">
						...
						<section>
							{recordingState === RECORDING_STATE.PAUSED ? (
								...
								<button
									...
									className="bg-secondary/60 p-2 rounded-md"
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
										width="24"
						...
						{/* Stop btn */}
						<button
							className='className="mx-auto  text-center text-lg bg-red-500 p-2 rounded-md hover:bg-red-600 focus:bg-red-800 focus:text-secondary/70'
